#Tue Feb 18 00:21:46 2025"""Automatically generated. DO NOT EDIT please"""
from GaudiKernel.GaudiHandles import *
from AthenaCommon.Configurable import *

class CaloCellsReader( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(CaloCellsReader, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'GepOutputReader'
  def getType( self ):
      return 'CaloCellsReader'
  pass # class CaloCellsReader

class WriteOutputHist( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'ClustersList' : [  ], # list
    'JetsList' : [  ], # list
    'GetJetConstituentsInfo' : True, # bool
    'GetJetSeedsInfo' : False, # bool
  }
  _propertyDocDct = { 
    'HistTitlePostfix' : """ The postfix for the histogram THx title """,
    'EvtStore' : """ Handle to a StoreGateSvc instance: it will be used to retrieve data during the course of the job """,
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(WriteOutputHist, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'GepOutputReader'
  def getType( self ):
      return 'WriteOutputHist'
  pass # class WriteOutputHist

class WriteOutputTree( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(WriteOutputTree, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'GepOutputReader'
  def getType( self ):
      return 'WriteOutputTree'
  pass # class WriteOutputTree
