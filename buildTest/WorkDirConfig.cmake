...
set( WorkDir_BASE_PROJECTS Athena;21.9.27 )
...
set( ATLAS_PLATFORM x86_64-slc7-gcc62-opt )

# Packages provided by the project:
set( WorkDir_PACKAGE_NAMES GepOutputReader;TrigL0GepPerf )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES GepOutputReaderPkg;GepOutputReaderPkgPrivate;GepOutputReader;TrigL0GepPerfPkg;TrigL0GepPerfPkgPrivate;TrigL0GepPerf )
